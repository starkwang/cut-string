...
function cutString(str, limit, options) {
    ...
    for (var _i = 0; _i < str.length;) {
        ...
        if (codePoint > 0xffff) {
            if (isRegionalIndicatorSymbol(codePoint) && isRegionalIndicatorSymbol(str.codePointAt(_i + 2)) || isEmojiModifierFitzpatrick(str.codePointAt(_i + 2))) {
            ...
            if (str.codePointAt(_i + 2) === 0x20e3) {
                chars.push([codePoint, nextCodePoint, str.codePointAt(_i + 2)]);
                _i += 3;
            } else {
